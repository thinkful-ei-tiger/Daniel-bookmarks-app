...
//Template for the landing pages
function startUpPage() {
  ...
  <section id="beginning" class="beginning"> 
    ...
    <h2 id="adding" class="initialAdd">Insert</h2>
      ...
      <section id="listContainer" class="listContainer">
          <section id="bookmarkList" class="listDisplay">
            ...
            <section class="listItems" id="filler">
                  ...
                  <p class="emptyMarks"><b>Fill me up...</b></p>
        ...
        <form class="addingNew">
          <fieldset>
            ...
            <section id="rating" class="rating">
              <h3>Try & find the ratings below :)</h3>
          ...
          <section class="linkRemove"> 
            <input type="button" alt="Cancel" id="cancel" value="Cancel"></button>
            <input type="submit" alt="Submit" id="addBookmark" value="Add"></button>
          </section>
        </form>
  ...
  for (let i = 0; i < list.length; i++) {
    ...
    <section id="${list[i].id}" class="listItems">
      ...
      <section class="moveRight">
        <input type="button" class="edit" value="edit"></button>
        <input type="button" class="delButton" value="delete"></button>
        <input type="button" border="0" alt="Submit" class="hidden save" value="confirm"></input>
      </section>
...
function bookmarkFormSubmit() {
  $("body").on("submit", ".addingNew", function (event) {
    ...
    $("#formContainer").toggleClass("hidden");
    api.saveBookmark().then(function () {
      $("#beginning").toggleClass("hidden");
      console.log("added");
...
function deleteBookmark() {
  $("body").on("click", ".delButton", function (event) {
    ...
    api.deleteBookmarks(id).then(function () {
      api.showBookmarks().then(function () {
        render();
      });
    });
  });
...
//List of bookmarks in the beggining
